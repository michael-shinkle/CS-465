...
router.route("/latestNews/:latestNewsCode").get(latestNewsController.latestNewsFindCode);
...
router.route("/testimonials/:testimonialCode").get(testimonialsController.testimonialsFindCode);
...
router.route("/vacationTips/:vacationTipCode").get(vacationTipsController.vacationTipsFindCode);
